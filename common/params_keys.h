...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"Ka2AeManual", {PERSISTENT | DEVELOPMENT_ONLY, BOOL}},
    {"Ka2AeExp", {PERSISTENT | DEVELOPMENT_ONLY, INT}},
    {"Ka2AeGainIdx", {PERSISTENT | DEVELOPMENT_ONLY, INT}},
    {"Ka2AeHcg", {PERSISTENT | DEVELOPMENT_ONLY, BOOL}},
