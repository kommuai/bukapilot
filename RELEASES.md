Version 9.8.3  (2025-03-17)
=========================
* ALERT: Assisted Lane Change cancel on blind spot detected was removed due to false positives, please manually check for blind spot for ALC.
...
* Assisted Lane Change removed minimum turn signal time
* Added Proton lks-tactile feature package
* Proton steering Lane Departure Warning fix
* Tuning for Proton X50/S70 for better stability
