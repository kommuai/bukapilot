...
def create_can_steer_command(packer, steer, steer_req, wheel_touch_warning, wheel_touch_warning_2, raw_cnt,\
    lks_aux, lks_audio, lks_tactile, lks_assist_mode, lka_enable, stock_ldw, enabled):
  ...
  values = {
    ...
    "LKS_LDW": 0 if (not enabled and (not lks_aux and lks_assist_mode) and (lks_tactile and not lks_audio)) else stock_ldw,
    "SET_ME_1_2": 1,
    "LKS_STATUS": 1,
