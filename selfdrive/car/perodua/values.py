...
BRAKE_SCALE = defaultdict(lambda: 1, {CAR.ATIVA: 3.1, CAR.MYVI_PSD: 3.3, CAR.ALZA: 2.6, CAR.VIOS: 3.2})
GAS_SCALE = defaultdict(lambda: 2600, {CAR.ATIVA: 0.4, CAR.MYVI_PSD: 0.35, CAR.ALZA: 0.4, CAR.VIOS: 0.4})

NOT_CAN_CONTROLLED = set([CAR.ARUZ, CAR.AXIA, CAR.BEZZA, CAR.MYVI])

ACC_CAR = set([CAR.ALZA, CAR.ATIVA, CAR.MYVI_PSD, CAR.VIOS])
