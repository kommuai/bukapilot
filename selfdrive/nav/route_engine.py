...
class NavigationRoute:
  ...
  def arrived(self, progress: RouteProgress) -> bool:
    return bool(progress.all_maneuvers) and progress.distance_remaining <= ARRIVAL_DISTANCE_METERS
