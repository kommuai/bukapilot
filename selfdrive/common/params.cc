...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"LogVideoWifiOnly", PERSISTENT},
    {"FanPwmOverride", PERSISTENT},
    ...
    {"Passive", PERSISTENT},
    {"PowerSaverEntryDuration", PERSISTENT},
    {"DrivePathOffset", PERSISTENT},
    ...
    {"UpdateStatus", CLEAR_ON_MANAGER_START},
    {"Version", PERSISTENT},
